<?php
    ...
    function last_login_is_recent() {
        // 60 seconds time 60 minutes is one hour.
        ...
        // If it is set, check to see if the time of the last login + the maximum time allowed is greater than the current time.
